...
import axios from '../utils/axios'; // axios instance with baseURL and withCredentials
...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.post('/auth/login', formData); // Axios instance auto prefixes /api
      dispatch(loginSuccess(res.data.user)); // You can also store token if needed
